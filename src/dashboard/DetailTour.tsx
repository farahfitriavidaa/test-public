...
function DetailTour() {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`https://biroperjalanan.datacakra.com/api/Tourist/${id}`, {
          headers: {
            'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjMxYWY1MTBlLTI3Y2EtNGQ0MS04NjM2LTA5MDcyZGEyM2U1MSIsImVtYWlsIjoiYmFkdUBnbWFpbC5jb20iLCJuYW1lIjoiU2kgQmFkdSIsImlhdCI6MTY5ODk4ODA5NSwiZXhwIjoxNjk5MDc0NDk1fQ.DOhTAsKfgd0duSFn99mxAkY_L0RG1TGgMWndZOewUr0', // Gantilah dengan token yang sesuai
  ...
  return (
    ...
    <Header />
    <h1 className="Font-Custom mx-5 mt-5">Detail Tourist</h1>
    <Link to='/list'>
    ...
    <div className="card w-75 mx-5">
        ...
        <h5 className="w-75 mt-2">{data ? data.id: 'Loading...'}</h5>
